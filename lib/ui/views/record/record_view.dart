...
class _RecordViewState extends State<RecordView> with WidgetsBindingObserver {
  ...
  void _initializeSpeechToText() {
    ...
    // Disable auto-pause completely or set to a higher value
    // _sttController.pauseIfMuteFor = null; // Disable auto-pause on silence
  }
  ...
  Future<Map<String, String>?> _formatText(String speechText) async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse(apiUrl),
        headers: {
          'Authorization': 'Bearer ${widget.tokenid}', // Replace widget.tokenid as needed
          'Content-Type': 'application/json; charset=UTF-8'
        },
        body: jsonEncode(body),
      );
