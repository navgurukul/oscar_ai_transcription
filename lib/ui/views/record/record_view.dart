...
//   try {
//     await _speech.startStt;//Start speech-to-text if applicable
...
class RecordView extends StatefulWidget {
  ...
  const RecordView({Key? key, 
  // required this.controller,
  required this.tokenid,required this.onRecordingComplete,}) : super(key: key);
...
class _RecordViewState extends State<RecordView> with WidgetsBindingObserver {
  ...
  Future<Map<String, String>?> _formatText(String speechText) async {
    ...
    try {
      ...
      print("Error making POST request: $e");
      // _showErrorDialog( 'An unexpecte error occurred: $e');
    } finally {
      if (mounted) {
      setState(() {
        _isLoading = false;
